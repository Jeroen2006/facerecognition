OC.L10N.register(
    ...
    "Ends approximately {estimatedFinalize}" : "Klaar {estimatedFinalize} (geschat)",
    ...
    "Please enter a name to rename the person" : "Vul een naam voor deze persoon in",
    "Rename" : "Hernoemen",
    ...
    "The analysis is enabled, please be patient, you will soon see your friends here." : "Gezichtsherkenning staat aan, je zal hier na een tijdje personen zien.",
    ...
    "Looking for your recognized friends" : "Herkende gezichten aan het zoeken",
    ...
    "Please, be patient" : "Het kan even duren, een moment geduld",
    "You will lose all the information analyzed, and if you re-enable it, you will start from scratch." : "Alle informatie zal verloren gaan en als je gezichtsherkenning weer aanzet moet je opnieuw beginnen.",
    ...
    "The minimum confidence determines how reliable must be a face detection to try to group it. Blurred or misaligned faces would have a confidence closer to 0.0, and the best images close to 1.0." : "Het minimum betrouwbaarheidsniveau bepaalt hoe betrouwbaar een gezicht moet zijn om het te groeperen. Vervaagde of verkeerd uitgelijnde gezichten hebben een betrouwbaarheid richting 0.0, en de beste afbeeldingen richting 1.0.",
    "Configuration information" : "Configuratie informatie",
    "Current status" : "Huidige status",
    "Stopped" : "Gestopt",
    "Persons are determined as groups of similar faces and to obtain them, all the faces found must be compared. When they are compared, a threshold is used to determine if they should be grouped." : "Personen worden gegroepeerd op basis van gelijksoortige gezichten, hiervoor moeten alle gezichten met elkaar vergeleken worden. Wanneer ze worden vergeleken is een een drempelwaarde die bepaald of ze bij elkaar gegroepeerd moeten worden.",
